...
This package works provides a wrapper to the mixbox C++ code to blend two colors
together via Rcpp.
...
We can blend two colors together like so, using the pigments defined by the
mixbox developers.
